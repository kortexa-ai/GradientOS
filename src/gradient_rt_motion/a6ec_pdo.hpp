...
constexpr uint16_t kOffTouchProbeFunction = 13; // 0x60B8:0 (16b)
constexpr uint16_t kOffMaxProfileVelocity = 15; // 0x607F:0 (32b)
...
constexpr uint16_t kOffTouchProbeStatus = 11; // 0x60B9:0 (16b)
constexpr uint16_t kOffTouchProbePos1 = 13;   // 0x60BA:0 (32b)
constexpr uint16_t kOffTouchProbePos2 = 17;   // 0x60BC:0 (32b)
